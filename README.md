...
`lavender census` reports identity coverage over a whole world in **counts only** —
how much of it is sourced, by which source, how stale, and why the unknowns are
unknown — never a per-artist list, `lavender corrections` / `lavender pending-corrections`
...
formatting/lint/SAST, strict typing, 1285 tests at 96% coverage, dependency and
